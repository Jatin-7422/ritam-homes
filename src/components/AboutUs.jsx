  ...
  const teamMembers = [
    {
      name: "Shyam Raj",
      role: "Founder & CEO",
      desc: "Leads product, strategy and everything in between.",
      image: null, // Replace with your image path like "/team/shyam.jpg"
    },
    {
      name: "Co-Founder",
      role: "Developer & Co-Founder",
      desc: "Builds and ships the platform end to end.",
      image: null,
    },
    {
      name: "Team Member",
      role: "Operations",
      desc: "Keeps listings verified and owners onboarded.",
      image: null,
    },
    {
      name: "Team Member",
      role: "Growth",
      desc: "Runs outreach across colleges and neighborhoods.",
      image: null,
    },
    {
      name: "Team Member",
      role: "Design",
      desc: "Shapes how Ritam Homes looks and feels.",
      image: null,
    },
  ];
      ...
      <div className="space-y-8">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2">
          ...
          <p className="text-xs sm:text-sm text-[#6E5D53] font-medium leading-relaxed">
            A team of five working to make renting feel safe again — starting in
            our own city.
          </p>
        </div>
