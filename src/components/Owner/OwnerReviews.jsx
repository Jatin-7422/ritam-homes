    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-[#6E5D53] mt-1">
          See what tenants are saying about your stays and feedback ratings.
        </p>
      </div>
      ...
      <div className="text-center py-24 bg-white rounded-3xl border border-[#EADBCE] shadow-sm p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto">
          ...
          <h3 className="text-2xl font-serif font-bold text-[#2D1F1A] mb-3">
            Tenant Reviews Module
          </h3>

          <p className="text-sm text-[#6E5D53] leading-relaxed mb-6">
            We are currently building an advanced rating and review system.
            Soon, you'll be able to read tenant feedback, respond to ratings,
            and analyze performance insights.
          </p>
